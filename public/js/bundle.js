...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var murkup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hlY2hlbHNrIiwiYSI6ImNsanBuMnUxczAwM3AzanA1dDJqbW1qeGsifQ.O0YBUn8pCjLU5AYDP_josQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    // Choose from Mapbox's core styles, or make your own style with Mapbox Studio
    style: 'mapbox://styles/chechelsk/cljq2h3qf00yd01p5hsfy70c4',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'New data successfully saved!');
            window.setTimeout(function () {
              location.reload(true);
            }, 1500);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51NWP2KD4ESFX5QzFVmGjXJofB85T3TuOOwY5sOy4fdTh3LryMpeJ8kjfasdmt20QwRC8tV7n4l5o16ymLvzi8ymZ00adQxeywe');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (event) {
    event.target.textContent = 'Procession...';
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var btn, passwordCurrent, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
